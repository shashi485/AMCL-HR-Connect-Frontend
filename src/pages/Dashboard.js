                ...
                {user?.role === 'Employee' ? (
                    <>
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                            ...
                            {/* Attendance Table */}
                            <div className="lg:col-span-2 bg-white rounded-2xl shadow-lg border">
                                ...
                                <table className="min-w-full">
                                    <thead className="bg-gray-50">
                                        <tr>
                                            ...
                                            <th className="px-6 py-3 text-left text-xs font-bold">Check In</th>
                                            <th className="px-6 py-3 text-left text-xs font-bold">Check Out</th>
